...
/**
 * 	\defgroup   facturesituationmigration     Module FactureSituationMigration
 *  \brief      FactureSituationMigration module descriptor.
 *
 *  \file       htdocs/facturesituationmigration/core/modules/modFactureSituationMigration.class.php
 *  \ingroup    facturesituationmigration
 *  \brief      Description and activation file for module FactureSituationMigration
 */
include_once DOL_DOCUMENT_ROOT.'/core/modules/DolibarrModules.class.php';

/**
 *  Description and activation class for module FactureSituationMigration
 */
class modLinkLines extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 300345; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module

		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'linklines';
		...
		$this->picto = 'fa-link_fas_#6c6aa8';
		...
		$this->langfiles = array("linklines@linklines");
		...
		if (!isset($conf->linklines) || !isset($conf->linklines->enabled)) {
			$conf->linklines = new stdClass();
			$conf->linklines->enabled = 0;
		}
